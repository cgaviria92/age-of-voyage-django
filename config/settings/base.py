"""Base settings for Age of Voyage project."""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-ml$*x150s&jau3p@sz7%v(oz51_4%6uy(agc*_u5!loiwsgr!3')
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='age_of_voyage'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Age of Voyage API',
    'DESCRIPTION': 'Naval exploration and trading game API',
    'VERSION': '1.0.0',
